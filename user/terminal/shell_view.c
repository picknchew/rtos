...
static const char *track_a =
    ...
    " A11.12       **  **                            **          **                          __    **  \r\n"   // 12 600
    "**__**          **  **                   B3.4 __              __ D15.16               **    __    \r\n"   // 13 650
    " B7.8 **          **  **     C9.10          **   B1.2   D13.14  ** E13.14         **      ** D9.10\r\n"   // 14 700
...
static const char *track_b =
    // 012345678901234567890123456789012345678901234567 8 9
    "    ****************************__********************__**************************__**********__**\r\n"   // 19 950
    "                             C3.4 **              ** C7.8                    A5.6 **       B9.10  \r\n"   // 18 900
    "                        E11.12  **  D11.12   C15.16 **           C5.6          A7.8 **__******__**\r\n"   // 17 850
    "            **************__**********__******__******************__********          **   B11.12 \r\n"   // 16 800
    "        **      **********__**********__******__******************__******  **    A9.10 **__**__**\r\n"   // 15 750
    " D9.10**      **         E13.14 **  D13.14   B1.2   **           C9.10    **  **          ** B7.8 \r\n"   // 14 700
    "    __    **               D15.16 __              __ B3.4                   **  **   A11.12 __    \r\n"   // 13 650
    "  **    __ E9.10                    **          **                            **  **         **   \r\n"   // 12 600
    "  ****                         B13.14 __      __ C1.2                             ****       **   \r\n"   // 11 550
    "  **                                    ******                               B15.16 __       **   \r\n"   // 10 500
    "  **                                      **                                        **       **   \r\n"   // 9 450
    ...
    "  ****                           D1.2 __      __ E1.2                             ****       **   \r\n"   // 6 300
    "  **    **                          **          **                            **  **         **   \r\n"   // 5 250
    "    **    __ D5.6            E3.4 __              __ E15.16               **    **   A15.16 __    \r\n"   // 4 200
    "      **      **     E5,6       **                  **           C11.12 **    **          **A13.14\r\n"   // 3 150
    "   D7.8 __      ******__**********--**************--****************__      **          **__******\r\n"   // 2 100
    "          **         E7.8                                          C13.14 **          ** A1.2     \r\n"   // 1 50-99
    "            **********__********************************************__*****************__********\r\n";   // 0 0-49
