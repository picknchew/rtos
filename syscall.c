...
int Create(int priority, void (*function)()) {
  ...
  asm volatile("svc %1" : "=r"(tid) : "i"(SYSCALL_CREATE), "r"(priority), "r"(function));
...
int MyTid() {
  ...
  asm volatile("svc %1" : "=r"(tid) : "i"(SYSCALL_MY_TID));
...
int MyParentTid() {
  ...
  asm volatile("svc %1" : "=r"(tid) : "i"(SYSCALL_MY_PARENT_TID));
