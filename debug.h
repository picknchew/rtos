...
void debug_dump_registers() {
  ...
  printf(
      "x0: %d, x1: %d, x2: %d, x3: %d x4: %d x5: %d\r\n",
      current_task->context.registers[0],
      current_task->context.registers[1],
      current_task->context.registers[2],
      current_task->context.registers[3],
      current_task->context.registers[4],
      current_task->context.registers[5]);
#endif
}
